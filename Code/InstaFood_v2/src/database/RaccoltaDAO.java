...
public class RaccoltaDAO {
    ...
    public List<entity.Raccolta> getRaccolteByUtente(int idUtente) {
        List<entity.Raccolta> raccolte = new ArrayList<>();
        String query = "SELECT * FROM instafood.Raccolta WHERE Utente_idUtente='" + idUtente + "';";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                raccoltaDAO.setIdRaccolta(rs.getInt("idRaccolta"));
                raccoltaDAO.setTitolo(rs.getString("Titolo"));
                raccoltaDAO.setDescrizione(rs.getBlob("Descrizione"));
                raccoltaDAO.setUtente_idUtente(rs.getInt("Utente_idUtente"));
                
                entity.Raccolta raccolta = new entity.Raccolta(raccoltaDAO);
