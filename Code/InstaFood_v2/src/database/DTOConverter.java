...
public class DTOConverter {
    ...
    public static UtenteDTO convertToDTO(UtenteDAO dao) {
        ...
        // Conversione Date -> Date (stesso tipo, assegnazione diretta)
        dto.setDataNascita(dao.getDataN());
        
        dto.setLuogoNascita(dao.getLuogoN());
        
        // Conversione Blob -> Blob (stesso tipo, assegnazione diretta)
        dto.setBiografia(dao.getBiografia());
    ...
    // Conversioni per RicettaDAO -> RicettaDTO
    public static RicettaDTO convertToDTO(RicettaDAO dao) {
        if (dao == null) return null;
        ...
        // Imposta i campi aggiuntivi
        dto.setRaccoltaId(dao.getRaccolta_idRaccolta());
        dto.setUtenteId(dao.getUtente_idUtente());
